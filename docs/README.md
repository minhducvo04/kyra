...
| Date | Plan | Status |
|---|---|---|
| 2026-09-06 | `outreach-assist.md` | Slices 1 and 2 built. |
| 2026-09-06 | `overnight-notes.md` | Built (posting signals, target posting, invented-number fix). |
| 2026-09-06 | `tool-calling-distill.md` | Measured; result in `../tool-calling-distill.md`. |
| 2026-09-06 | `v2-phase1.md` | Slices 1 to 4 built; Terraform validated, never applied. |
| 2026-09-07 | `health-companion.md` | Plan only; band decided (Garmin vivosmart 5). |
| 2026-09-07 | `human-interface.md` | Streaming, cancel, presence, transcript, phone layout built. |
| 2026-09-07 | `mass-apply.md` | Slices 1 to 3 built (Greenhouse, Ashby, Lever, LinkedIn hand-off, Workday fetch). |
| 2026-09-07 | `semantic-search.md` | Slices 1 to 4 built. |
| 2026-09-07 | `visionos.md` | Client builds and talks to the Mac; presence orb and Today tab built. |
| 2026-09-08 | `ambient-assistant.md` | Concept and research only. |
| 2026-09-08 | `attention-environment.md` | Slices 0 to 4 built (focus blocks); 5 to 7 open. |
| 2026-09-08 | `going-public.md` | Auth boundary, `/healthz`, `render.yaml` built; repo public since 2026-09-09; no deploy yet. |
| 2026-09-09 | `codex-onboarding.md` | This restructure, and how Codex joins the project. |
