...
| File | What it is |
|---|---|
| [working-loop.md](working-loop.md) | Personal Codex/Claude calls, private execution receipts and independent review comments. |
...
| `plans/2026-09-09-destructive-guard.md` | Deferred. No hooks are configured; the plan starts with a recoverable snapshot before considering per-harness guards. |
